...
class PwAll extends Component {
    ...
    state = {
        ...
        message: this.props.data[0]?.message ?? this.props.t("commands.commandPokeAll.message.value")
    }
            ...
            <Grid item xs={12} md={12} lg={12}>
                ...
                <Card style={{
                    ...
                    <ValidatorForm
                        ...
                        onSubmit={(e) => null}
                    >
                        <InputLabel style={{ marginTop: '1rem' }} id="rights">{t("commands.commandPokeAll.rights")}</InputLabel>
                        <Select
                            labelid="rights"
                            style={{ width: "50%" }}
                            name="rights"
                        ...
                        <InputLabel style={{ marginTop: '1rem' }} id="message">{t("commands.commandPokeAll.message.key")}</InputLabel>
                        <TextValidator
                            labelid="message"
                            style={{ width: "50%" }}
                            onChange={(e) => this.handleChange(e)}
